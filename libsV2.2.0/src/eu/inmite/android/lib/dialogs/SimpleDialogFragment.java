...
/**
 * Dialog for displaying simple message, message with title or message with
 * title and two buttons. Implement {@link ISimpleDialogListener} in your
 * Fragment or Activity to rect on positive and negative button clicks. This
 * class can be extended and more parameters can be added in overridden build()
 * method.
 * 
...
public class SimpleDialogFragment extends BaseDialogFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (targetFragment != null) {
			...
			if (args != null) {
				mRequestCode = args.getInt(BaseDialogBuilder.ARG_REQUEST_CODE,
						0);
			}
		}
	}
	...
	public static class SimpleDialogBuilder extends
			BaseDialogBuilder<SimpleDialogBuilder> {
		...
		protected SimpleDialogBuilder(Context context,
				FragmentManager fragmentManager,
		...
		/**
		 * When there is neither positive nor negative button, default "close"
		 * button is created if it was enabled.<br/>
		 * Default is true.
		 */
		...
		protected Bundle prepareArguments() {
			if (mShowDefaultButton && mPositiveButtonText == null
			...
			args.putString(SimpleDialogFragment.ARG_POSITIVE_BUTTON,
					mPositiveButtonText);
			args.putString(SimpleDialogFragment.ARG_NEGATIVE_BUTTON,
					mNegativeButtonText);
